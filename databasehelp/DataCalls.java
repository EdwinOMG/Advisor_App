...
//  selects student info
    ...
    public static void insertStudentCourseDetails(int studentId, String courseId, StudentCourseDetails studentCourseDetails) {
        ...
        try (Connection connection = getConnection(URL, Username, Password);
            ...
            statement.setInt(6, studentCourseDetails.isCourseCompletion() ? 1 : 0);
            System.out.println(studentCourseDetails.isCourseCompletion() ? 1 : 0);

            statement.executeUpdate();

            System.err.println("Warning: Attempted to insert null studentCourseDetails");
