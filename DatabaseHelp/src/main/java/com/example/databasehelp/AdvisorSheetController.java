...
public class AdvisorSheetController {
    ...
    private void initialize() {
        ...
        courseRequirementManager = new CourseRequirementManager();
        ...
        courseRequirementManager.initializeCheckBoxListeners(first_table);
        courseRequirementManager.initializeSecondCheckBoxListeners(second_table, 2);
        courseRequirementManager.initializeSecondCheckBoxListeners(third_table, 3);
        courseRequirementManager.initializeSecondCheckBoxListeners(fourth_table, 4);
        courseRequirementManager.initializeSecondCheckBoxListeners(pre_table, 5);

        first_table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        second_table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        third_table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        fourth_table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        pre_table.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
    }
